...
<head>
    ...
    <!-- Favicons-->
    <link rel="icon" href="<?= base_url('asset/images/favicon/favicon-32x32.png'); ?>" sizes="32x32">
    <!-- Favicons-->
    <link rel="apple-touch-icon-precomposed" href="<?= base_url('asset/images/favicon/apple-touch-icon-152x152.png');?> ">
    <!-- For iPhone -->
    ...
    <!-- CORE CSS-->    
    <link href="<?= base_url('asset/css/materialize.css" type="text/css" rel="stylesheet" media="screen,projection');?> ">
    <link href="<?= base_url('asset/css/style.css" type="text/css" rel="stylesheet" media="screen,projection');?> ">


    <!-- INCLUDED PLUGIN CSS ON THIS PAGE -->    
    <link href="<?= base_url('asset/js/plugins/perfect-scrollbar/perfect-scrollbar.css" type="text/css" rel="stylesheet" media="screen,projection');?> ">
    <link href="<?= base_url('asset/js/plugins/jvectormap/jquery-jvectormap.css" type="text/css" rel="stylesheet" media="screen,projection');?> ">
    <link href="<?= base_url('asset/js/plugins/chartist-js/chartist.min.css" type="text/css" rel="stylesheet" media="screen,projection');?> ">
...
<body>
        ...
        <div class="navbar-fixed">
            <nav class="cyan">
                <div class="nav-wrapper">
                    <h1 class="logo-wrapper"><a href="index.html" class="brand-logo darken-1"><img src="<?= base_url('asset/images/materialize-logo.png" alt="materialize logo'); ?> "></a> <span class="logo-text">Materialize</span></h1>
                    ...
                    <li class="user-details cyan darken-2">
                        <div class="row">
                            ...
                            <div class="col col s8 m8 l8">
                                ...
                                <a class="btn-flat dropdown-button waves-effect waves-light white-text profile-btn" href="#" data-activates="profile-dropdown">Muhammad Syammes<i class="mdi-navigation-arrow-drop-down right"></i></a>
    ...
    <!--scrollbar-->
    <script type="text/javascript" src="<?= base_url('asset/js/plugins/perfect-scrollbar/perfect-scrollbar.min.js'); ?> "></script>
       

    <!-- chartist -->
    <script type="text/javascript" src="<?= base_url('asset/js/plugins/chartist-js/chartist.min.js'); ?> "></script>   

    <!-- chartjs -->
    <script type="text/javascript" src="<?= base_url('asset/js/plugins/chartjs/chart.min.js'); ?> "></script>
    <script type="text/javascript" src="<?= base_url('asset/js/plugins/chartjs/chart-script.js'); ?> "></script>

    <!-- sparkline -->
    <script type="text/javascript" src="<?= base_url('asset/js/plugins/sparkline/jquery.sparkline.min.js'); ?> "></script>
    <script type="text/javascript" src="<?= base_url('asset/js/plugins/sparkline/sparkline-script.js'); ?> "></script>
    ...
    <script type="text/javascript" src="<?= base_url('asset/js/plugins/jvectormap/vectormap-script.js'); ?> "></script>
